...
<c:choose>
    <c:when test="${'en' eq pageContext.response.locale}">
        <s:url var="flashAdvertUrl" value="https://s3.eu-central-1.amazonaws.com/lukasfloor/flash/slogans_en.swf"  />
    </c:when>
    <c:otherwise>
        <s:url var="flashAdvertUrl" value="https://s3.eu-central-1.amazonaws.com/lukasfloor/flash/slogans.swf"  />
    </c:otherwise>
</c:choose>
